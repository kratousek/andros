...
public class pars {
    ...
    public int convToMicro(int AValue){
        int ret = 0;
        if (AValue<=255){
            return(8890);
        }
    ...
    /*** Konstruktor c.2 nastavi callback pro zapis do grafu, tabulky ***/
    public pars(OnGeekEventListener mListener){
        InitConstants();
